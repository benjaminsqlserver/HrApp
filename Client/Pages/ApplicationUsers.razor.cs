...
namespace HrApp.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<HrApp.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<HrApp.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(HrApp.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(HrApp.Server.Models.ApplicationUser user)
        {
            try
            {
